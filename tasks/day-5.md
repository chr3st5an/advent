...
procedure, but they forgot to ask her which crate will end up where, and they want
to be ready to unload them as soon as possible so they can embark.
...
from bottom to top, they are crates M, C, and D. Finally, stack 3 contains a single
crate, P.
...
<b>Before the rearrangement process finishes, update your simulation so that the
